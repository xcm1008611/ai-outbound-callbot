...
import com.qidiangk.smart.resource.service.sms.properties.SmsResponse;
...
public class SmsClientController implements SmsClient {
    ...
    public R<Boolean> sendSingle(@RequestBody SmsRequestSingleDTO smsRequestSingleDTO) {
        return R.data(smsBuilder.getTemplate(smsRequestSingleDTO.getCode()).sendSingle(smsRequestSingleDTO.getMap(), smsRequestSingleDTO.getPhone()));
    }
}
