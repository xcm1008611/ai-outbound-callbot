package com.qidiangk.smart.system.controller.city;
...
public class CityController extends BaseController {
    ...
    @Function(value = "列表",menus = {
            ...
            @Menu(name="城市列表", client = "admin",menuCode = "CALL_LINE",code = "CALL_LINE_CITY_LIST",type = Menu.TYPE.INTERFACE)
    })
    ...
    public R<Long> save(@Validated(Validation.Create.class) @RequestBody CoreCity coreCity){
